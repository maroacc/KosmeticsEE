...
public class DAOBrands {
    ...
    public static boolean addBrand(Brand brand){
        boolean ok = true; //
        try {
            PreparedStatement pstmt = conBD.getConnection().prepareStatement("INSERT INTO brands (name, username, password," +
            ...
            pstmt.setNString(4, brand.getUsername());
            ...
            pstmt.setNString(11, brand.getName());
