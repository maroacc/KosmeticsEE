...
<div class="container">
    <div class="kosmetics">
        <p id="titulillo">Estadísticas globales</p>
...
<c:if test="${listaProductos.size() < 5}">
    <div class="d-flex justify-content-center row mt-3">
        <h5 class="col-12 text-center mb-5" style="color:#888888; font-family:Montserrat" >Publica al menos 5 productos para poder acceder a estadísticas globales sobre tu marca</h5>
...
<c:if test="${listaProductos.size() >= 5}">
    ...
    <div class="container">
        <section class="main row">
            ...
            <div class="col-xs-12 col-md-5 col-lg-3">
                <img src="assets/images/bases.jpg" style="width: 50%" class="rounded">
            </div>
            <div class="col-xs-12 col-md-5 col-lg-3">
