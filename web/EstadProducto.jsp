...
<c:if test="${listaProductos.size() < 5}">
    <div class="d-flex justify-content-center row mt-3">
        <h5 class="col-12 text-center mb-5" style="color:#888888; font-family:Montserrat" >Al menos 5 personas deben haber comprado tu producto para poder obtener estadísticas</h5>
