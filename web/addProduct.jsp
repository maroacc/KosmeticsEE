...
<div class="d-flex justify-content-center mb-5 " >
    <form class="col-10 col-lg-8 col-xl-6 needs-validation" enctype="multipart/form-data" id="form" onsubmit="return validate();" action="carrito" method="post" novalidate>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="inputNombre" name="inputNombre" aria-describedby="nombreHelpBlock">
        ...
        <div class="my-3">
            ...
            <textarea class="form-control" id="validationTextarea" placeholder="Descripción del producto" name="description" aria-describedby="descriptionHelpBlock" required></textarea>
        ...
        <div class="form-group">
            ...
            <div class="form-row">
                <div class="input-group col-lg-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="inputPrecio" name="precio" aria-describedby="emailHelp" required>
